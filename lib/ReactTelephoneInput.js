...
var ReactTelephoneInput = exports.ReactTelephoneInput = React.createClass({
    ...
    handleInputKeyDown: function handleInputKeyDown(event) {
        ...
        // prevent user from overridding country code
        if (event.which === keys.BACKSPACE) {
            var dialCode = '+' + this.state.selectedCountry.dialCode;
            var formattedNumber = this.state.formattedNumber;
            if (dialCode === formattedNumber) event.preventDefault();
        }
    },
        ...
        return React.createElement(
            ...
            React.createElement(
                ...
                React.createElement(
                    ...
                    React.createElement(
                        'div',
                        { className: inputFlagClasses, style: this.getFlagStyle(), tabIndex: '-1' },
